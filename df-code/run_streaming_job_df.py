...
with beam.Pipeline(options=options) as pipeline:
    ...
    messages = pipeline | ReadFromPubSub(subscription='projects/valid-verbena-437709-h5/subscriptions/dataops-dataflow-sub')
    ...
    orders_data | 'Write orders to BigQuery' >> WriteToBigQuery(
        table='valid-verbena-437709-h5:dataops.customer_orders',
